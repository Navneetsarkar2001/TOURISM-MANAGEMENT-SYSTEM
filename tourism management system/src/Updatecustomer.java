...
public class Updatecustomer extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource()==b1)
        {
            ...
            String Q = "update customer set username='"+username+"',id='"+id+"',number='"+number+"',name='"+name+"',gender='"+radio+"',country='"+Country+"',address='"+Address+"',phone='"+Phone_no+"',email='"+Email_Id+"')";

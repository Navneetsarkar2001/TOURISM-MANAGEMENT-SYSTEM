...
public class Bookhotel extends JFrame implements ActionListener
{
    ...
    Bookhotel(String username)
    {
        ...
        c1.setBounds(250,110,150,20);
        add(c1);
        JLabel l4 = new JLabel("Total Persons: ");
        l4.setBounds(20,150,120,30);
        add(l4);
        ...
        c2.add("Yes");
        c2.add("No");
        c2.setBounds(250,230,150,20);
        add(c2);

        JLabel l7 = new JLabel("Food Included:");
        l7.setBounds(20,270,120,30);
        add(l7);

        c3 = new Choice();
        c3.add("Yes");
        c3.add("No");
        c3.setBounds(250,270,150,20);
        add(c3);
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                l22.setText(rs.getString("id_type"));

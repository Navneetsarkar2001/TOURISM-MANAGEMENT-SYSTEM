...
public class DeleteCustomer extends JFrame implements ActionListener
{
    ...
    DeleteCustomer(String username)
    {
       ...
       l16.setBounds(250,270,100,16);
       add(l16);

       JLabel l7 = new JLabel("Address");
       l1.setBounds(30,310,100,16);
       add(l1);

       JLabel l17 = new JLabel();
       l17.setBounds(250,310,100,16);
       add(l17);
       ...
       {
         Conn c = new Conn();
         ResultSet rs = c.s.executeQuery("select * from customer where username = 'nav@'");   
         while(rs.next())
         {
             l11.setText(rs.getString("username"));
             l12.setText(rs.getString("name"));
             l13.setText(rs.getString("id_type"));
